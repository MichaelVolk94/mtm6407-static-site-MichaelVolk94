...
function submitForm() {
  // In a real project, you'd send the data to an API or form service here.
...
<div class="contact-page">
    <h1>Contact Me</h1>
    <p>If you'd like to connect, and follow me, feel free to reach out using the form below!</p>
